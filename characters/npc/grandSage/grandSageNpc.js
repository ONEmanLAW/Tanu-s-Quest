...
let dialoguesInForet = [
  ...
  { text: "Hohhh Tanu, oui désolé je sais pas bien utiliser cette grenouille.\nLa technologie c'est tellement complexe.", boxType: "GrandSage" },
  { text: "...", boxType: "Hero" },
  { text: "Bon, il faut que tu sauves les 9 Tanukis qui sont dans la forêt,\ntu peux voir en haut à gauche, combien tu en as sauvé.", boxType: "GrandSage" },
...
let dialoguesFinishForet = [
  { text: "LE GRAND SAGE A UN MESSAGE POUR VOUS CROAAAA", boxType: "Grenouille" },
  { text: "...", boxType: "Hero" },
  { text: "Tanu je ressens que tu as sauvé tous les villageois.", boxType: "GrandSage" },
  { text: "Tu as aussi récupéré la pierre de la terre.", boxType: "GrandSage" },
  { text: "Je te l'ai pas dit.\n. Mais les quatre pierres te permettront d'ouvrir les portails.\nTu pourras aller au château et vaincre le boss.", boxType: "GrandSage" },
